...
export class EquipmentBookingController {
  constructor(private readonly equipmentBookingService: EquipmentBookingService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateEquipmentBookingDto: UpdateEquipmentBookingDto) {
